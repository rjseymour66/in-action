...
import (
	...
	"github.com/rjseymour66/in-action/concurrency/patterns/pool"
)

const (
	maxGoroutines	= 25	// number of goroutines to use
...
// createConnection is a factory method that is called by the pool
